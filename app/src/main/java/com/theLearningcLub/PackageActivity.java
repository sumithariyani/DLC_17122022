...
//        ReviewApi();
        ...
        if (set_key.equals("2")){
            new PackageActivity.AddDataTask().execute();
        }else {
            activityPackageBinding.tvPackageRs.setText(s_price+"");
...
//                new HomeFragment.AddtoCartAs2().execute();
//            }else{
//                new HomeFragment.AddtoCartAs1().execute();
//            }
            new AddtoCartAs1().execute();
        }
    }
                    ...
                    response -> {
                        ...
                        try {
                            ...
                            if (jsonArray.isNull(0)){
                                ...
                                activityPackageBinding.noDataFoundGif.setVisibility(View.GONE);
                                Glide.with(PackageActivity.this).asGif().load(R.drawable.nodatagif).into(activityPackageBinding.noDataFoundGif);
                            }else {
...
//            CommonFunction.showToastSingle(mContext,getResources().getString(R.string.net_connection));
    ...
    class view_download_list_asy extends AsyncTask<String, String, String> {
        ...
        String status,s_id,s_desc,s_video_date,s_title,s_video,s_video_new,s_image,s_v_id,is_free="";
...
//            hashMap.put("key", sessionManager.getLoginkey());
            hashMap.put("user_id", sessionManager.getSavedUserId());
//
            String response = webRequest.makeWebServiceCall(AllUrl.view_package_video_list_new,2,hashMap);
//
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    JSONObject jsonObject1 = jsonArray.getJSONObject(i);
                        ...
                        s_video_new = jsonObject1.getString("video_url");
