...
public class ChaptervideoAdapter1 extends RecyclerView.Adapter<ChaptervideoAdapter1.MyViewHolder> {
    ...
    public ChaptervideoAdapter1(Context context, List<ClassModel1> moviesList,FilterClick filterClick,FilterClickCart filterClickCart) {
