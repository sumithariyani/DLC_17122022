...
public class CustomListAdapter extends ArrayAdapter {
    ...
    public CustomListAdapter(Context context, int resource, List<String> storeDataLst, List<String> storeDataidLst) {
        super(context, resource, storeDataLst);
        dataList = storeDataLst;
        dataidList = storeDataidLst;
        mContext = context;
        itemLayout = resource;
    }
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        Typeface  GoogTypeface = Typeface.createFromAsset(view.getContext().getAssets(), "GoogleSans-Regular.ttf");

        strName.setText(getItem(position));

        strName.setTypeface(GoogTypeface);
