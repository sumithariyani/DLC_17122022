...
public class GeneralAdapter2 extends RecyclerView.Adapter<GeneralAdapter2.MyHolder>{
    ...
    public GeneralAdapter2(List<DatumGeneralKnowledgeModel> datumGeneralKnowledgeModels, Context context, FilterClick filterClick, FilterClickCart filterClickCart) {
