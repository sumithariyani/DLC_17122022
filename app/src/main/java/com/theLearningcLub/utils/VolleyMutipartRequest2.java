...
public class VolleyMutipartRequest2 extends Request<String> {
    ...
    public VolleyMutipartRequest2(String url, Map<String, String> headers,
    ...
    public VolleyMutipartRequest2(int method, String url,
                                  Response.Listener<String> listener,
                                  Response.ErrorListener errorListener) {
